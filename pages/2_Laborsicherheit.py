...
# Hilfsfunktion zum Anzeigen eines einzelnen Bildes mit Info-Button
def bild_mit_info(dateiname, beschreibung, key_suffix):
    ...
    if os.path.exists(bildpfad):
        with st.container():
            st.image(bildpfad, width=120)  # ⬅️ Bildgröße angepasst
...
# --- Zweiter Bereich: Notfallsymbole ---
