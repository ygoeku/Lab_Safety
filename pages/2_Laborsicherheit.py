...
def load_image_with_info(filename, beschreibung, mehr_info):
    if os.path.exists(filename):
        ...
        img = img.resize((300, 300))  # Alle Bilder gleich groß 300x300 Pixel
...
# Liste der Bilder mit richtiger Schreibweise (ohne (1), ohne Leerzeichen)
bild_liste = [
